var vApp = angular.module('vApp', ['ngRoute']);
...
//services
vApp.factory('dataService', ['$http', 'serviceBasePath', function ($http, serviceBasePath) {
    var fac = {};
...
//http interceptor
vApp.config(['$httpProvider', function ($httpProvider) {
